...
alias l.='exa -a | egrep "^\." | lolcat'
alias vim='nvim'
alias timetable='python3 $HOME/python/timetable.py | lolcat'
...
alias rainfetch='neofetch | lolcat'
alias compdir='sshfs karttikeya@192.168.1.15:/home/karttikeya ~/sshfs'
alias disk='df -h | lolcat'
# alias eix='eix | lolcat'
...
# echo
# echo
python3 $HOME/python/timetable.py | lolcat
